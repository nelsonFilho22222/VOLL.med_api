...
class ConsultaControllerTest {
   ...
   @WithMockUser
    void agendarQuandoRequisicaoMalFeita() throws Exception {
    ...
    @WithMockUser
    void agendarQuandoTudoDerCerto() throws Exception {
        ...
        var jsonEsperado = dadosDetalhamentoConsultajson.write(
                new DadosDetalhamentoConsulta(null, 2L, 5L, data, especialidade)
        ).getJson();
